...
export const ICON = "absolute w-10 h-10 md:h-6 md:w-6 top-2 right-2";

export const IMAGE= "object-contain w-36 h-36 md:w-24 md:h-24";

export const CARD_TEXT = "text-3xl font-bold text-center capitalize md:text-base";